...
describe('GET /api/class-details/:lessonId', () => {
  test('should respond with 401 if user not logged in', (done) => {
    request(app)
      .get('/api/class-details/62aa68f2e26aeee64245e5d2')
  ...
  test('should respond with 200 and selected lesson if user is admin', (done) => {
    request(app)
      .get('/api/class-details/62aa68f2e26aeee64245e5d2')
      .set('Content-Type', 'application/json')
      .set({ userRole: 'admin' })
